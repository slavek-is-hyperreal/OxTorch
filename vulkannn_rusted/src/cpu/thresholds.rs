...
define_thresholds! {
    ...
    // ---------------------------------------------------------------------
    // EXP (unary) — no explicit legacy gate; 512_000 = migrated-tree convention.
    // ---------------------------------------------------------------------
    ExpBf16 => ("EXP_BF16", 512_000),
    ExpF16 => ("EXP_F16", 512_000),
    ExpF32 => ("EXP_F32", 512_000),

    // ---------------------------------------------------------------------
    // GELU (unary)
    // ---------------------------------------------------------------------
    /// src/cpu_old/ops/unary/gelu/gelu_f32.rs:6 — legacy `PAR_THRESHOLD`.
    GeluBf16 => ("GELU_BF16", 512_000),
    GeluF16 => ("GELU_F16", 512_000),
    GeluF32 => ("GELU_F32", 64_000),

    // ---------------------------------------------------------------------
    // MAX (reduction) — src/cpu_old/ops/reduction/max/*.rs PAR_LIMIT = 128_000.
    // ---------------------------------------------------------------------
    MaxBf16 => ("MAX_BF16", 128_000),
    MaxF16 => ("MAX_F16", 128_000),
    MaxF32 => ("MAX_F32", 128_000),
    MaxI8 => ("MAX_I8", 128_000),
    ...
    // ---------------------------------------------------------------------
    // SUM (reduction) — src/cpu_old/ops/reduction/sum/*.rs PAR_LIMIT = 256_000.
    // ---------------------------------------------------------------------
    SumBf16 => ("SUM_BF16", 256_000),
    SumF16 => ("SUM_F16", 256_000),
    SumF32 => ("SUM_F32", 256_000),
    SumI8 => ("SUM_I8", 256_000),
