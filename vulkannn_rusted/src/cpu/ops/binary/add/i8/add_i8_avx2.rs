//! AVX2 Implementation for I8 Add (saturating, `_mm256_adds_epi8`).
//! Transcribed from cpu_old/ops/binary/add/add_i8.rs (legacy avx2 kernel).
//!
...
pub unsafe fn add_i8_avx2(a: &[i8], b: &[i8], res: &mut [i8]) {
    let n = a.len();
    let n32 = (n / 32) * 32;
