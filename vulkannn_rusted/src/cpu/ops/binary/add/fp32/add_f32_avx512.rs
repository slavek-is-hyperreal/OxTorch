...
//!
//! BENCH: PENDING (hw: x86_64 w/ AVX-512F+DQ+VL+FMA). Reference box (i5-3450)
//! is Ivy Bridge — no AVX-512 — so this cannot be measured here. Compiles on
//! x86_64; gated behind NON_TEMPORAL_MIN like avx1/avx2 until measured on real
//! AVX-512 silicon (Skylake-X onward).
