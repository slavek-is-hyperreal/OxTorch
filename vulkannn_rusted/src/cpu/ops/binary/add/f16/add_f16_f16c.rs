//! F16C Implementation for F16 Add (hardware f16<->f32 convert + AVX add).
//! Transcribed from cpu_old/ops/binary/add/add_f16.rs (legacy f16c kernel).
//!
...
pub unsafe fn add_f16_f16c(a: &[half::f16], b: &[half::f16], res: &mut [half::f16]) {
    let n = a.len();
    let n8 = (n / 8) * 8;
