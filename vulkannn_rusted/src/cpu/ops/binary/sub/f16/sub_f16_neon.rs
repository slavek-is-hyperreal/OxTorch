//! NEON Implementation for F16 Sub (f32 upcast path).
//! Transcribed from cpu_old/ops/binary/sub/sub_f16.rs (incl. u16<->f16 fix).
//!
...
#[cfg(target_arch = "aarch64")]
pub unsafe fn sub_f16_neon(a: &[half::f16], b: &[half::f16], res: &mut [half::f16]) {
    let n = a.len();
    let n4 = (n / 4) * 4;
