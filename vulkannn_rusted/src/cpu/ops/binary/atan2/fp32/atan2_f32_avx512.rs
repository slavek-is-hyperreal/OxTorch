...
//!
//! BENCH: PENDING (hw: x86_64 w/ AVX-512F+DQ+VL). Reference box (i5-3450) lacks
//! AVX-512. Compiles on x86_64; expected to beat avx2 (wider lanes + k-mask
//! predication), but unmeasured — no number until run on real AVX-512 silicon.
