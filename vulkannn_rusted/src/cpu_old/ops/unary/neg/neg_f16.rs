/// Elementwise negation for F16 tensors.
pub fn neg_f16(in_buf: &[half::f16], out_buf: &mut [half::f16]) {
...
/// In-place negation for F16 tensors.
pub fn neg_f16_inplace(buf: &mut [half::f16]) {
