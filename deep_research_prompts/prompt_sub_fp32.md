...
- IMPORTANT: Review techniques used in scientific libraries like **BLIS**, **libxsmm**, **FFTW**, and open-source physics simulators (e.g., GROMACS, LAMMPS) for Sub in FP32.
